...
abstract public class Animation {
	...
	static public void enlargeCard (final CardPanel overPanel, final ClientFrame clientFrame, long delay) {
		...
		final CardPanel animationPanel = new CardPanel(overPanel.gameCard, false);
